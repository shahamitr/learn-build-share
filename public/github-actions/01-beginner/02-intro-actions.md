...
## Lab: Create First Workflow

1.  **Create Directory:** In your repository, create `.github/workflows/`.
2.  **Create File:** Create a file named `hello.yml`.
3.  **Content:**
    ```yaml
    name: Hello World
    on: push
    ...
    ```
4.  **Push:** Commit and push the file.
5.  **View:** Go to the **Actions** tab in your repository to see it run.
